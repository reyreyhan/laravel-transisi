                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('employee.update', $employee->id) }}" enctype='multipart/form-data'>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input id="name" type="text" name="name" value="{{ $employee->name }}" required="required" autofocus="autofocus" class="form-control" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input id="name" type="email" name="email" value="{{ $employee->email }}" required="required" autofocus="autofocus" class="form-control" />
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="project_name" class="col-md-3 col-form-label text-md-right ">Select Company</label>
                                <div class="col-md-9">
