                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('company.update', $data->id) }}" enctype='multipart/form-data'>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input id="name" type="email" name="email" value="{{ $data->email }}" required="required" autofocus="autofocus" class="form-control" />
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="project_name" class="col-md-3 col-form-label text-md-right">Company Logo (upload if want to update)</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group row">
                                ...
                                <img src="{{ url($data->logo) }}" class="img-fluid" alt="Responsive image" width="300" height="300">
                            </div>

                            <div class="form-group row">
                                <label for="project_name" class="col-md-3 col-form-label text-md-right">Website</label>
                                <div class="col-md-9">
                                    <input id="name" type="text" name="website" value="{{ $data->website }}" required="required" autofocus="autofocus" class="form-control" />
                                </div>
                            </div>
